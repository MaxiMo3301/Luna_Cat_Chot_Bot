...
# Load Environment variables from the .env fuke
load_dotenv()
...
class Config:
    ...
    def validate_config():
        ...
        if Config.TTS_MODEL == 'voicerss' and not Config.VOICERSS_API_KEY:
            raise ValueError("CARTESIA_API_KEY is required for VoiceRSS models")
